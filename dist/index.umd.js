(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Contents = factory());
	...
	*/
	...
	Contents.config = (userConfig = {}) => {
	  ...
	  const difference = lodash.difference(Object.keys(userConfig), properties);
	  ...
	  const instanceConfig = lodash.assign({}, defaultConfig, userConfig);
	...
	Contents.articles = (elements, articleName = Contents.articleName, articleId = Contents.articleId) => {
	  return lodash.map(elements, (element) => {
	    const article = {};
